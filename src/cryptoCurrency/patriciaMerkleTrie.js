//实现一个MerklePatriciaTree

/**
 * 实验要求
 * ⽤ Javascript 实现 以太坊MPT
 * MPT 要能够存储账户的数据和内容
 * MPT 的索引依照以太坊账户的格式建⽴ (0x95222290dd7278aa3ddd389cc1e1d165cc4bafe5)
 * 为 MPT 添加和更新地址的函数
 * 使⽤ npm: keccak256 作为其哈希函数计算 Root 值
 * 提供验证函数能够根据地址和余额信息验证 MPT 数据的正确性
 */
